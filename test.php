...
<i class="feather icon-x input-group-text"></i>
 ...
 <i class="feather icon-search input-group-text"></i>
                            ...
                            <li>
                                <a href="#!" onclick="if (!window.__cfRLUnblockHandlers) return false; javascript:toggleFullScreen()" class="waves-effect waves-light" data-cf-modified-1fe1b88cea5b2fe8354363ed-="">
...
<option value="3">@twitter</option>
                                                ...
                                                <button type="button" class="btn btn-primary waves-effect waves-light add" onclick="if (!window.__cfRLUnblockHandlers) return false; add_row();" data-cf-modified-1fe1b88cea5b2fe8354363ed-="">Add Row</button>
                                            </div>
                                        </div>
